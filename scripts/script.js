  ...
  <main>
      <section id="hero">
          ...
          <div class="content">
              ...
              <p class="bold">${t('hero-1')}</p>
              <p class="bold cyan">${t('hero-2')}</p>
      ...
      <section id="services">
          <h2 class="section-header">${t('services-header')}</h2>
          <p class="under-header-text">${t('services-under-header')}</p>
          <div class="service-cards">
              ...
              <div class="card">
                  <div class="card-header">
                      <span class="material-symbols-outlined green">trip</span>
                      <h3>${t('professional-card-header')}</h3>
                  </div>
                  <p class="card-text">
                      ${t('professional-card-p')}
                  </p>
                  <ul>
                      <li>
                          <div>
              ...
              <div class="card">
                  <div class="card-header">
                      <span class="material-symbols-outlined orange">domain</span>
                      <h3>${t('companiy-card-header')}</h3>
                  </div>
                  <p class="card-text">
                      ${t('companiy-card-p')}
                  </p>
      ...
      <section id="approach">
          <h2 class="section-header">${t('approach-header')}</h2>
          <p class="under-header-text">${t('approach-under-header')}</p>
      ...
      <section id="contact-us">
          <button id="contact-btn">
              ${t('contact-us-btn')} <span class="material-symbols-outlined">keyboard_arrow_right</span>
          </button>
          <div id="contactModal" class="modal">
            <div class="modal-content">
                <button class="close-modal-btn">&times;</button>
                <h2 class="form-title">${t('form-header')}</h2>
                ...
                <form id="contactForm">
                    <div class="form-group">
                        <label for="form-name">${t('form1')}</label>
                        <input type="text" id="form-name" name="name" placeholder="${t('form1placeholder')}" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="form-phone">${t('form3')}</label>
                        <input type="tel" id="form-phone" name="phone" placeholder="${t('form3placeholder')}">
                    </div>
...
function getAboutContent() {
  ...
  <section id="join-us">
      ...
      <p>${t('join-4')}</p>
      <p>${t('join-5')}</p>
      <p class="bold">${t('join-6')}</p>
  </section>
  <section id="about-contact-us">
      <h3>${t('contact-us-header')}</h3>
      <div class="contact-options">
          <div class="contact-card">
              <svg class="blue" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail-icon lucide-mail"><path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"/><rect x="2" y="4" width="20" height="16" rx="2"/></svg>
              <h4>Email</h4>
              <p>PL_peoplepersonsneeds2@outlook.com</p>
          </div>
          <div class="contact-card">
